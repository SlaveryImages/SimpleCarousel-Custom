...
class CarouselBlockForm extends Form
{
	public function init()
	{
		...
		$this->add([
			'name' => 'o:block[__blockIndex__][o:data][yearSlider]',
			'type' => Element\Checkbox::class,
			'options' => [
				'label' => 'Year Slider',
				'info' => 'Custom slide show style with a year range slider.'
			]
		]);

		$this->add([
			'name' => 'o:block[__blockIndex__][o:data][startYear]',
			'type' => Element\Text::class,
			'options' => [
				'label' => 'Slider start year',
				'info' => 'The starting year for the custom year slider.'
			]
		]);

		$this->add([
			'name' => 'o:block[__blockIndex__][o:data][endYear]',
			'type' => Element\Text::class,
			'options' => [
				'label' => 'Slider end year',
				'info' => 'The ending year for the custom year slider.'
			]
		]);
	}
}
